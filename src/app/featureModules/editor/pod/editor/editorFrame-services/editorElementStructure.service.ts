    ...
    public removeElement = function (Obj, element, childjson, sectionCount, fromIndex, tillIndex, state) {
        ...
        if (element) {
            if (element.previousElementSibling == '' || element.previousElementSibling == null) {
                ...
                element.parentNode.setAttribute('break', 'break_condition');
                // element.parentNode.setAttribute('style', 'page-break-before: always');
            }
            else {
                element.previousElementSibling.setAttribute('break', 'break_condition');
            }
        ...
        /////// venkat - remove previous sibling elements (ETS component) - 20/04/2022 - start

        if(projectstandard == 'ETS' && element && element.classList.contains("root-container")){
            if(element.previousSibling.previousSibling.lastChild.nodeName.toLowerCase() == 'hr'){
                element.previousSibling.previousSibling.lastChild.remove();
            }
        }

        if(projectstandard == 'ETS' && element && element.classList.contains("root-container") && element && element.classList.contains("page-break")){
            if(element && element.parentNode && (element.getAttribute('id') != element.parentNode.firstChild.getAttribute('id'))){
                while(element.nextSibling){
                    element.parentNode.removeChild(element.nextSibling);
                }
            }
        }
        // if(projectstandard == 'ETS' && element && element.parentNode.nodeName.toLowerCase() == 'b' && element.parentNode.parentNode.parentNode.nodeName.toLowerCase() == 'div' && 
        ...
        /////// venkat - remove previous sibling elements (ETS component) - 20/04/2022 - end
